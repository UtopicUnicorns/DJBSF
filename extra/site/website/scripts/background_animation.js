var w = (colour_background.width = window.innerWidth),
	h = (colour_background.height = window.innerHeight),
	ctx = colour_background.getContext('2d'),
	opts = {
		len: 50,
		count: 500,
		baseTime: 10,
...
window.addEventListener('resize', function () {
	w = colour_background.width = window.innerWidth;
